...
class View:
    ...
    def create_grid(self, toggle_row_num=None):
        ...
        for equipment in data:
            ...
            button.connect("clicked", self.toggle_article, grid, equipment, i)
            ...
            if equipment["picture"]:
                ...
                btn_picture = ButtonWithImage("image-x-generic-symbolic", tooltip="View picture", connect=utils.picture_frame, data=picture)
    ...
    def toggle_article(self, source, grid, equipment, row_num):
        ...
        for article in articles:
            ...
            if equipment["consumable"]:
                btn_use = ButtonWithImage("edit-redo-symbolic", tooltip="Use", connect=self.dialog_use, data=article)
                linked_btn.pack_end(btn_use, False, True, 0)
            # Modify
            btn_modify = ButtonWithImage("document-edit-symbolic", tooltip="Modify", connect=self.dialog_modify, data=article)
            linked_btn.pack_end(btn_modify, False, True, 0)
            # Delete
            btn_delete = ButtonWithImage("edit-delete-symbolic", tooltip="Delete", connect=self.dialog_delete, data=article)
