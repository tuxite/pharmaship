# -*- coding: utf-8 -*-
"""Export utility class for Telemedical Equipment Inventory."""
import datetime
...
class Export:
    ...
    def pdf_print(self):
        """Export the telemedical equipment inventory in PDF."""
    ...
    def __export_html(self, template_filename):
        ...
        # Get article data (dict type)
        data = parser(self.params)

        # Create context
        context = Context({
            "title": _("Telemedical Equipment Inventory"),
