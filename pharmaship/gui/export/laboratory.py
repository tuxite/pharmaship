# -*- coding: utf-8 -*-
"""Export utility class for Laboratory Equipment Inventory."""
import datetime
...
TEMPLATE = "laboratory.html"
CSS = "report.css"


class Export:
    """Class for pdf export of laboratory equipment."""
    ...
    def pdf_print(self):
        """Export the laboratory equipment inventory in PDF."""
