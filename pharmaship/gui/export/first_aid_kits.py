# -*- coding: utf-8 -*-
"""Export utility class for First Aid Kits Inventory."""
import datetime
...
TEMPLATE = "first_aid_kits.html"
CSS = "report.css"


class Export:
    """Class for pdf export of first aid kits."""
    ...
    def pdf_print(self):
        """Export the first aid kits inventory in PDF."""
    ...
    def __export_html(self, template_filename):
        ...
        # Create context
        context = Context({
            "title": _("First Aid Kits Inventory"),
