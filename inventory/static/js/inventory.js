...
(function ($) {
    ...
    function click_filter() {
        ...
        $(link).click(function (e) {
            ...
            sticky_header(); // To reset the wrapper
            // Any change?
            if (state === true) {
                // Show the panel
                panel.show();
    ...
    /* Function to stick the header and animate the back top top action. */
    function sticky_header() {
        $('#medicine_table_header').waypoint('sticky', {
                                         context: 'div.ui-layout-content',
                                         });
