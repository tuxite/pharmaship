...
TEMPLATE = """
<div id="debug" style="clear:both; background: white;">
<p>Total SQL number: {{ sql|length }}</p>
<a href="#debugbox"
...
<ol>
{% for query in sql %}
    <li><pre>{{ query.sql|linebreaksbr }}</pre><p>took {{ query.time|floatformat:"4" }} seconds</p></li>
{% endfor %}
</ol>
